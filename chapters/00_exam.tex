...
\begin{quote}\small
Uriol Balbin, I., Bisagni, C., \& Smith, J. (2020). Thermal control parameters in spacecraft reentry structures. \textit{Journal of Spacecraft and Rockets}, \textit{57}(3), 412--425.
\end{quote}
...
\begin{quote}\small
{[1]} Uriol Balbin, I., Bisagni, C., and Smith, J. ``Thermal Control Parameters in Spacecraft Reentry Structures,'' \textit{Journal of Spacecraft and Rockets}, Vol.~57, No.~3, 2020, pp.~412--425.
\end{quote}
...
\begin{tabular}{@{}p{2.4cm}p{5.2cm}p{7.4cm}@{}}
  ...
  \midrule
  Simple random & Equal probability for every element & Underrepresents rare sub-groups \\[3pt]
  Convenience   & What is available & May not represent long-term or broader trends \\[3pt]
